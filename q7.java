...
public class q7 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("To Check The Positive And Negative Number");

        jLabel2.setFont(new java.awt.Font("Times New Roman", 3, 18)); // NOI18N
        jLabel2.setText("Enter no.");

        txtN.setFont(new java.awt.Font("Times New Roman", 3, 18)); // NOI18N
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(N>0) 
            JOptionPane.showMessageDialog(null,"lt is +ve");
        else if(N<0) 
            JOptionPane.showMessageDialog(null,"It is-ve");
        else
            JOptionPane.showMessageDialog(null,"it is Zero");
